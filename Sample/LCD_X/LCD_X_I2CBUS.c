...
static void _Send1(U8 Data) {
  if (Data&(1<<7)) LCD_SET_SDA_IN(); else LCD_CLR_SDA_IN(); LCD_SET_SCL(); LCD_CLR_SCL();
  if (Data&(1<<6)) LCD_SET_SDA_IN(); else LCD_CLR_SDA_IN(); LCD_SET_SCL(); LCD_CLR_SCL();
  if (Data&(1<<5)) LCD_SET_SDA_IN(); else LCD_CLR_SDA_IN(); LCD_SET_SCL(); LCD_CLR_SCL();
  if (Data&(1<<4)) LCD_SET_SDA_IN(); else LCD_CLR_SDA_IN(); LCD_SET_SCL(); LCD_CLR_SCL();
  if (Data&(1<<3)) LCD_SET_SDA_IN(); else LCD_CLR_SDA_IN(); LCD_SET_SCL(); LCD_CLR_SCL();
  if (Data&(1<<2)) LCD_SET_SDA_IN(); else LCD_CLR_SDA_IN(); LCD_SET_SCL(); LCD_CLR_SCL();
  if (Data&(1<<1)) LCD_SET_SDA_IN(); else LCD_CLR_SDA_IN(); LCD_SET_SCL(); LCD_CLR_SCL();
  if (Data&(1<<0)) LCD_SET_SDA_IN(); else LCD_CLR_SDA_IN(); LCD_SET_SCL(); LCD_CLR_SCL();
  LCD_SET_SCL(); LCD_CLR_SCL();
}
